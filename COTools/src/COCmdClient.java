 ...
 * @usage Application
 */
public class COCmdClient implements Runnable {
   ...
   */
  public COCmdClient(COBase parent, String host, int port) {
    this.parent = parent;
    this.host = host;
    this.port = port;
   ...
   * @throws IOException
   */
  public COCmdClient(COBase parent, Socket socket) throws IOException {
    this.parent = parent;
    this.socket = socket;
